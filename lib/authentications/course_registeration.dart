...
class RegisterCourse extends StatefulWidget {
  RegisterCourse(
      {Key? key, this.width, this.isAppBar = true, this.isSeparate = false})
      : super(key: key);
  final bool isAppBar;
  final double? width;
...
class _RegisterCourseState extends State<RegisterCourse> {
  ...
  // verification(nic,date) {
  //   ///verification code:  concat nic + completion date  divide by completion date and then  divide by 1.8
  //   // var ver1 = nic;
  //   // // var ver1 = '987654334567829';
  //   // var ver2 = Connect.completionDate(formatedDate);
  //   // // var ver2 = '20210809';
  //   var verify = int.parse('$nic$date') / int.parse(date.toString());
  //   var generate = (verify / 20);
  //   // print(generate.round().toString().replaceRange(4, 5, '-').replaceRange(9, 10, '-'));
  //   return generate.round().toString().replaceRange(4, 5, '-').replaceRange(9, 10, '-');
  // }
...
Future  register() async {
    var res =
        await http.post(Uri.parse("${AppUrl.temp}student/insert"), body: {
      "name": name,
      "address": address,
      "NIC": nic,
      "phoneNo": phoneNo,
      ...
      "about": about,
      "verification": Connect.verification(nic, formatedDate).toString(),
      "registration": Connect.registrationNo(nic, formatedDate).toString(),
...
Widget form(){return  SingleChildScrollView(
  scrollDirection: Axis.vertical,
  child: Container(width: _width > 800 ? 800 : _width,
    child: Column(
      children: [
        const SizedBox(
          height: 10,
...
8: If you require further clarifications, please reach us on ${AppUrl.phoneNo} ''',
                ...
                Padding(
                  padding:  EdgeInsets.symmetric(
                      vertical: 10, horizontal:_width>600? 15:2),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text(
                ...
                Container(
                  ...
                  margin:  EdgeInsets.symmetric(
                      vertical: 30, horizontal:_width>600? 15:2),
                  child: _width > 598.0
                      ? Row(
                    children: <Widget>[
                      Text(
                        ...
                        items: const [
                          DropdownMenuItem(
                            child: ListTile(
                              ...
                              subtitle: Text(
                                  'Khattak plaza 3rd floor Front side'),
                            ),
                    ...
                    child: Padding(
                      ...
                      child: DropdownButton(
                        ...
                        items: [
                          ...
                          DropdownMenuItem(
                            child:
                            Text('Risk Assessment Level 2&3'),
                          ...
                          if (signUpkey.currentState!.validate()) {
                            ...
                            await  register(). then(
                              ...
                              content: Text(
                                value == 200
                                    ? "Student Registered"
                                    : "Check you Internet connection or refresh your page",
                                style: TextStyle(
                                    color: value == 200
                                        ? AppColors.text
                                        : Colors.red),
